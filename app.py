...
.st-emotion-cache-1vxmjmh [data-testid="stText"] {
...
#     "name" : "누오",
#     "types" : ["물", "땅"],
#     "image_url" : "https://i.namu.wiki/i/XHeFBzMUNzZaG4JLJh-Nmkwzrmb9jwEcridThyc44mBqKBgK1nGlemRTtXs0SEN3YOHIVHNKw5CWpWu-oerevIc9opB99xIthgGFwkiwkSL0vILBIsH0a03LN1H1RfA_nRS7hQE8-gCiqebJ5OFJZQ.webp"
# }
...
print("page_reload, auyto_complete", auto_complete)
with st.form(key="form"):
    ...
    if submit:
        if not name:
            ...
            st.error("포켓몬의 속성을 적어도 한개 이상 선택해주세요.")
        else:
